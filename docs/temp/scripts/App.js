...
var RevealOnScroll = function () {
  function RevealOnScroll(classToCatch, offsetSet) {
    _classCallCheck(this, RevealOnScroll);

    this.classToCatch = classToCatch;
    this.offsetSet = offsetSet;
    this.itemsToReveal = (0, _jquery2.default)(this.classToCatch);
    this.hideInitially();
  ...
  _createClass(RevealOnScroll, [{
    ...
    value: function createWaypoints() {
      var off = this.offsetSet;
      this.itemsToReveal.each(function () {
        var currIt = this;
        new Waypoint({
          element: currIt,
          handler: function handler() {
            return (0, _jquery2.default)(currIt).addClass("reveal-item--is-visible");
          },
          offset: off
        });
      });
    ...
    value: function createHeaderWaypoint() {
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          return direction === "down" ? header.addClass("site-header--dark") : header.removeClass("site-header--dark");
        }
      });
    }
  }, {
    ...
    value: function createPageSectionWaypoints() {
      ...
      this.pageSections.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction === "down") {
              var matchingHeaderLink = currIt.getAttribute("data-matching-link");
              that.headerLinks.removeClass("is-current-link"); //REMOVE THE CLASS FROM ALL THE LINKS
              (0, _jquery2.default)(matchingHeaderLink).addClass("is-current-link"); //SELECT THE div BY THE VAL OF THE CUSTOM ATTR
            }
          },
          offset: "18%"
        });
...
// this.openModalButton.click(this.openModal().bind(this));
// this.closeModalButton.click(this.closeModal().bind(this));
// window.keypress((key)=>{if(key==="esc"&&this.modal.getAttribute()==="is-visible")this.closeModalButton.click(this.closeModal().bind(this);})
